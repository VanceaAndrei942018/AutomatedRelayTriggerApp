@InjectConfig(simpleBindings = {
    @InjectBinding(bind = MessagingProvider.class, to = SmsMessagingProvider.class)
})
package com.vadelectronics.b_platform;
...
import com.vadelectronics.b_platform.messaging.SmsMessagingProvider;
